    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="message" style="margin-top:10%">
                <h1 style="font-size:100px; font-family: 'Karla', sans-serif; font-weight:800;"> CONTACT US! </h1>
            </div>
        ...
        <section class="maps">
            <div class="message" style="margin-top:10%">
                <h1 style="font-size:80px; font-family: 'Karla', sans-serif; font-weight:800;"> YOU CAN FIND US HERE </h1>
            </div><br>
            <center>
